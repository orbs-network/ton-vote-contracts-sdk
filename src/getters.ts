import { executeMethodWithRetry, min, promiseAllWithRetry, randomSleep, sleep } from "./helpers";
...
import { readJettonMinterMetadata, readNftCollectionMetadata } from "./jetton-nft";
...
async function getJettonMetadata(client : TonClient, votingPowerStrategies: VotingPowerStrategy[]) {
    ...
    try {
        ...
        return await readJettonMinterMetadata(client, votingPowerStrategies[0].arguments[0].value);    
    } catch (err) {
